...
public class RingTorusTest {
   ...
   */
   @Test public void setters() {
      ...
      Assert.assertEquals(false, tester.setLargeRadius(2.0));
      Assert.assertEquals(false, tester.setSmallRadius(4.0));
   }
   /**
...
*/
   ...
   */
   ...
   @Test public void equal() {
      ...
      tester2 = new RingTorus("tester", 3.0, 4.0);
      Assert.assertEquals("equals incorrect", false, tester.equals(tester2));
      tester2 = new RingTorus("tester", 4.0, 3.0);
      Assert.assertEquals("equals incorrect", false, tester.equals(tester2));
...
/** Tests the compare to method. **/
   @Test public void compareTo() {
      RingTorus tester = new RingTorus("tester", 4.0, 2.0);
      RingTorus tester2 = new RingTorus("tester", 4.0, 2.0);
      Assert.assertEquals(0, tester.compareTo(tester2));
      
      RingTorus tester3 = new RingTorus("tester", 40.0, 20.0);
      Assert.assertEquals(-1, tester.compareTo(tester3));
      
      RingTorus tester4 = new RingTorus("tester", 1.0, 1.0);
      Assert.assertEquals(1, tester.compareTo(tester4));
